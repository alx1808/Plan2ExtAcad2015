    ...
    internal static class Globs
    {
        ...
        public static bool CallCommand(params object[] parameter)
        {
            ...
            try
            {
				...
				{
					var tpName = o.GetType().Name;

					switch (tpName)
					{
						case "String":
							rb.Add(new _AcDb.TypedValue((int)_AcBrx.LispDataType.Text, o.ToString()));
							break;
						case "Int32":
							rb.Add(new _AcDb.TypedValue((int)_AcBrx.LispDataType.Int32, Convert.ToInt32(o)));
							break;
						case "Point3d":
							rb.Add(new _AcDb.TypedValue((int)_AcBrx.LispDataType.Point3d, (_AcGe.Point3d)o));
							break;
						case "Double":
				...
				var result = Bricscad.Global.Editor.Command(rb);
#else
        ...
        internal static string AskKeywordFromUser(string question, string[] words, int defaultWordIndex = -1, bool allowArbitraryInput = false)
        {
            ...
            var pr = _AcAp.Application.DocumentManager.MdiActiveDocument.Editor.GetKeywords(pko);
        ...
        {
            return (_AcGe.Point3d)_AcAp.Application.GetSystemVariable("VIEWCTR");
